...
class sfViewConfigHandler extends sfYamlConfigHandler
{
    ...
    protected function addComponentSlots($viewName = '')
    {
        ...
        foreach ($components as $name => $component) {
            ...
            $data .= "  if (sfConfig::get('sf_logging_enabled')) \$this->context->getEventDispatcher()->notify(new sfEvent(\$this, 'application.log', [sprintf('Set component \"%s\" (%s/%s)', '{$name}', '{$component[0]}', '{$component[1]}')]));\n";
        }

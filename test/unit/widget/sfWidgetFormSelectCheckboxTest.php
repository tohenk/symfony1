...
'<li><input name="foo[]" type="checkbox" value="foobar" id="foo_foobar" checked />&nbsp;<label for="foo_foobar">foo</label></li>'.
'</ul>';
...
'<li><input name="foo[]" type="checkbox" value="foobar" id="foo_foobar" onChange="alert(42)" checked />'.
...
$output = <<< 'EOF'
<ul class="checkbox_list"><li><input name="myname[]" type="checkbox" value="0" id="myname_0" checked />&nbsp;<label for="myname_0">bar</label></li>
...
<li><input name="myname[]" type="checkbox" value="1" id="myname_1" checked />&nbsp;<label for="myname_1">foo</label></li></ul>
EOF;
...
$output = <<<'EOF'
foo <ul class="checkbox_list"><li><input name="foo[]" type="checkbox" value="foo" id="foo_foo" checked />&nbsp;<label for="foo_foo">bar</label></li>
<li><input name="foo[]" type="checkbox" value="bar" id="foo_bar" />&nbsp;<label for="foo_bar">foo</label></li></ul>
bar <ul class="checkbox_list"><li><input name="foo[]" type="checkbox" value="foobar" id="foo_foobar" checked />&nbsp;<label for="foo_foobar">barfoo</label></li></ul>
EOF;
...
<li><input name="foo[]" type="checkbox" value="bar" id="foo_bar" checked />&nbsp;<label for="foo_bar">foo</label></li></ul>
EOF;

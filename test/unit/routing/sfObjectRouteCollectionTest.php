...
$url = $routes['test_object']->generate(['key' => 123, 'action' => 'export']);
...
$t->isa_ok($routes['test_collection']->matchesUrl($url, ['method' => 'get']), 'array', '->generateRoutes() creates a wildcard collection route that matches a URL it generates');
